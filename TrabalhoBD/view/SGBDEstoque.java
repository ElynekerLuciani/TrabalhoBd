...
public class SGBDEstoque {
	...
	private JTextField InscricaoEstadualCF;
	...
	private void initialize() {
		...
		JLabel InscricaoEstadual = DefaultComponentFactory.getInstance().createTitle("Inscri\u00E7\u00E3o estadual:");
		
		JPanel CancelarCF = new JPanel();
		
		JPanel VisualizarFornecedoresCF = new JPanel();
		
		JPanel CadastrarCF = new JPanel();
		
		JPanel VisualizarVF = new JPanel();
		...
		JLabel Visualizar = DefaultComponentFactory.getInstance().createTitle("Visualizar fornecedor");
		Visualizar.setBounds(34, 18, 147, 16);
		VisualizarVF.add(Visualizar);
		Visualizar.setForeground(Color.BLACK);
		Visualizar.setFont(new Font("Arial", Font.PLAIN, 16));
		
		//VisualizarFornecedoresVF
		VisualizarVF.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				VisualizarVF.setBackground(new Color(0,100,0));
				Visualizar.setForeground(Color.white);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				VisualizarVF.setBackground(new Color(50,205,50));
				Visualizar.setForeground(Color.black);
			}
		});
		VisualizarVF.setBackground(new Color(50,205,50));
		VisualizarVF.setBounds(571, 450, 213, 50);
		ArticleVFornecedor.add(VisualizarVF);
		VisualizarVF.setLayout(null);
		...
		PessoaFisica.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				if(PessoaFisica.isSelected()){
					...
					InscricaoEstadualCF.setVisible(false);
		...
		PessoaJuridica.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				if(PessoaJuridica.isSelected()){
					...
					InscricaoEstadualCF.setVisible(true);
		...
		//Inscrição Estadual
		InscricaoEstadual.setFont(new Font("Arial", Font.PLAIN, 16));
		InscricaoEstadual.setBounds(51, 346, 129, 16);
		InscricaoEstadual.setVisible(false);
		ArticleCFornecedor.add(InscricaoEstadual);
		
		InscricaoEstadualCF = new JTextField();
		InscricaoEstadualCF.setDocument(new Documento(11,"[\\D&&[^-]]"));
		InscricaoEstadualCF.setForeground(Color.LIGHT_GRAY);
		InscricaoEstadualCF.setColumns(10);
		InscricaoEstadualCF.setText("00000000-00");
		InscricaoEstadualCF.addFocusListener(new FocusListener() {
			
			@Override
			public void focusLost(FocusEvent e) {
				if(InscricaoEstadualCF.getText().length()<=0 && InscricaoEstadualCF.getForeground()==Color.black){
					InscricaoEstadualCF.setText("00000000-00");
					InscricaoEstadualCF.setForeground(Color.LIGHT_GRAY);
				}
			}
			...
			@Override
			public void focusGained(FocusEvent e) {
				if(InscricaoEstadualCF.getText().length()>0 && InscricaoEstadualCF.getForeground()==Color.LIGHT_GRAY){
					InscricaoEstadualCF.setText("");
					InscricaoEstadualCF.setForeground(Color.black);
				}
			}
		});
		InscricaoEstadualCF.setVisible(false);
		InscricaoEstadualCF.setBounds(51, 366, 539, 25);
		ArticleCFornecedor.add(InscricaoEstadualCF);
		...
		JLabel VisualizarFornecedores = DefaultComponentFactory.getInstance().createTitle("Visualizar fornecedores");
		VisualizarFornecedores.setBounds(28, 18, 164, 16);
		VisualizarFornecedoresCF.add(VisualizarFornecedores);
		VisualizarFornecedores.setForeground(Color.BLACK);
		VisualizarFornecedores.setFont(new Font("Arial", Font.PLAIN, 16));
		
		//VisualizarFornecedoresCF
		VisualizarFornecedoresCF.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				VisualizarFornecedoresCF.setBackground(new Color(0,100,0));
				VisualizarFornecedores.setForeground(Color.white);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				VisualizarFornecedoresCF.setBackground(new Color(50,205,50));
				VisualizarFornecedores.setForeground(Color.black);
			}
		});
		VisualizarFornecedoresCF.setBackground(new Color(50,205,50));
		VisualizarFornecedoresCF.setBounds(571, 450, 213, 50);
		ArticleCFornecedor.add(VisualizarFornecedoresCF);
		VisualizarFornecedoresCF.setLayout(null);
